...
--
-- Host: localhost    Database: interna_db
-- ------------------------------------------------------
...
CREATE TABLE `assessment` (
  ...
  `task_i_d` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `assessed_by` bigint NOT NULL,
  `score` int NOT NULL,
  `category` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `aspect` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `quality_score` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `speed_score` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `initiative_score` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `teamwork_score` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `communication_score` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `strengths` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `intern_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `assessments` (
  ...
  `assessed_by` bigint NOT NULL,
  `score` int NOT NULL,
  `category` enum('very_good','good','not_good','very_bad') COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS ((case when (`score` >= 85) then _utf8mb4'very_good' when (`score` >= 70) then _utf8mb4'good' when (`score` >= 50) then _utf8mb4'not_good' else _utf8mb4'very_bad' end)) STORED,
  `aspect` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `attendance` (
  ...
  `late_reason` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `notes` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `attendances` (
  ...
  `status` enum('present','late','absent','sick','permission','on_leave','excused') COLLATE utf8mb4_unicode_ci DEFAULT 'absent',
...
) ENGINE=InnoDB AUTO_INCREMENT=9089 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `interns` (
  ...
  `status` enum('pending','active','completed','cancelled','terminated') COLLATE utf8mb4_unicode_ci DEFAULT 'active',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `leave_requests` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `intern_id` bigint NOT NULL,
  `leave_type` enum('sick','permission','other') COLLATE utf8mb4_unicode_ci NOT NULL,
  `start_date` date NOT NULL,
  `end_date` date NOT NULL,
...
CREATE TABLE `notifications` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` bigint NOT NULL,
  `type` enum('info','success','warning','error','task_assigned','task_deadline','task_approved','task_revision','task_submitted','new_intern_registration','new_supervisor_registration','assessment_created','attendance_late') COLLATE utf8mb4_unicode_ci DEFAULT 'info',
...
CREATE TABLE `reports` (
  ...
  `type` enum('weekly','monthly','final') COLLATE utf8mb4_unicode_ci DEFAULT 'weekly',
...
CREATE TABLE `supervisors` (
  ...
  `status` enum('pending','active') COLLATE utf8mb4_unicode_ci DEFAULT 'active',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE `task_attachments` (
  ...
  `file_type` enum('jpg','jpeg','png','pdf') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `tasks` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `submission_method` enum('links','files','both') COLLATE utf8mb4_unicode_ci DEFAULT 'both',
  `start_date` date NOT NULL,
  `target_date` date DEFAULT NULL,
  `completed_date` date DEFAULT NULL,
  `status` enum('pending','scheduled','in_progress','submitted','revision','completed','overdue','cancelled') COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','supervisor','pembimbing','intern','new_user') COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2026-02-12  4:32:46
