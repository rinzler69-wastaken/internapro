...
type Task struct {
	...
	IsUnscheduled      bool             `json:"is_unscheduled"`
	AssignerID         *int64           `json:"assigner_id,omitempty"`
	CustomAssignerName *string          `json:"custom_assigner_name,omitempty"`
	...
	AssignerName   string `json:"assigner_name,omitempty"`
	AssignerRole   string `json:"assigner_role,omitempty"`
}
