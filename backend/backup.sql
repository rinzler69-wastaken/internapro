...
CREATE TABLE `assessments` (
  ...
  CONSTRAINT `assessments_ibfk_3` FOREIGN KEY (`assessed_by`) REFERENCES `supervisors` (`id`) ON DELETE RESTRICT,
...
) ENGINE=InnoDB AUTO_INCREMENT=9079 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','supervisor','pembimbing','intern') COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2026-02-11  9:06:52
