<script>
  ...
  const canManage = $derived(
    role === "admin" || role === "pembimbing" || role === "supervisor",
  );
...
<aside
  class={`sidebar ${!isMobile && collapsed ? "collapsed" : ""} ${mobileOpen ? "open" : ""}`}
>
  ...
  <div class="nav-section">
    ...
    >
      <span class="nav-icon material-symbols-outlined" aria-hidden="true"
    ...
    {#if canManage}
      <a
        ...
        use:route
        onclick={closeMobileSidebar}
        class={`nav-link ${path.startsWith("/interns") ? "active" : ""}`}
    ...
    {#if role === "admin"}
      <a
        ...
        use:route
        onclick={closeMobileSidebar}
        class={`nav-link ${path.startsWith("/supervisors") ? "active" : ""}`}
    ...
    <a
      ...
      use:route
      onclick={closeMobileSidebar}
      class={`nav-link ${path.startsWith("/tasks") ? "active" : ""}`}
      data-tooltip="Penugasan"
    >
      <span class="nav-icon material-symbols-outlined" aria-hidden="true"
        >assignment</span
      >
    ...
    <a
      ...
      use:route
      onclick={closeMobileSidebar}
      class={`nav-link ${path.startsWith("/attendance") ? "active" : ""}`}
    ...
    <a
      ...
      use:route
      onclick={closeMobileSidebar}
      class={`nav-link ${path.startsWith("/calendar") ? "active" : ""}`}
  ...
  <div class="nav-section">
    ...
    <a
      ...
      use:route
      onclick={closeMobileSidebar}
      class={`nav-link ${path.startsWith("/reports") ? "active" : ""}`}
    ...
    <a
      ...
      use:route
      onclick={closeMobileSidebar}
      class={`nav-link ${path.startsWith("/assessments") ? "active" : ""}`}
  ...
  <div class="nav-section">
    ...
    <a
      ...
      use:route
      onclick={closeMobileSidebar}
      class={`nav-link ${path.startsWith("/notifications") ? "active" : ""}`}
    ...
    <a
      ...
      use:route
      onclick={closeMobileSidebar}
      class={`nav-link ${path.startsWith("/profile") ? "active" : ""}`}
      data-tooltip="Profil"
    >
      <span class="nav-icon material-symbols-outlined" aria-hidden="true"
        >person</span
  ...
  {#if role === "admin"}
    <div class="nav-section">
      ...
      <a
        ...
        use:route
        onclick={closeMobileSidebar}
        class={`nav-link ${path.startsWith("/settings") ? "active" : ""}`}
  ...
  {#if canManage}
    <div class="nav-section">
      ...
      <a
        ...
        use:route
        onclick={closeMobileSidebar}
        class={`nav-link ${path.startsWith("/data-tools") ? "active" : ""}`}
        data-tooltip="Pusat Data"
      >
        <span class="nav-icon material-symbols-outlined" aria-hidden="true"
          >import_export</span
        >
