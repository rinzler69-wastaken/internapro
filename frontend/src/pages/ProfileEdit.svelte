                ...
                <div class="card-body">
                    ...
                    <div class="avatar-section">
                        ...
                        <div class="avatar-text">
                            ...
                            <p class="text-sm text-slate-500">Klik ikon kamera untuk mengubah.<br>Maksimal 2MB (JPG/PNG).</p>
                        </div>
                    </div>
            ...
            <div class="card security-card">
                ...
                <div class="card-body">
                    ...
                    <div class="action-area mt-8">
                        <button class="btn-blue w-full" onclick={updatePassword} disabled={savingPassword}>
